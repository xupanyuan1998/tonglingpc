  ...
  <div>
    ...
    <div class="warp">
      <div class="title">
        ...
        <p class="fu" v-if="content.attachment!=''"><span>附件: </span> <a :href="content.attachment" :download="content.attachmentName">{{content.attachmentName}}</a></p>
      </div>
    </div>
    <div class="footer">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.axios.post('/web/user/details',data).then(({data})=>{
